...
function displayNextstep() {
  ...
  if (billAmount < 1) {
    message.innerHTML = "Please retry with valid bill amount.";
  } else {
...
function getChange() {
  ...
  if (billAmount > cashReceived) {
    ...
    message.innerHTML = "No amount needs to be returned.";
  } else {
...
enter.addEventListener("click", getChange);
next.addEventListener("click", displayNextstep);
